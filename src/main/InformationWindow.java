...
public class InformationWindow {
	...
	public void infoLocation(String title, String author, ArrayList<String> info, URL img) {
		...
		JLabel label3 = new JLabel("<html>" + "Title: " + title + "<br/>" + "Artist: " + author + "<br/>" + "Lifespan: "
				+ info.get(6) + "<br/>" + "Date: " + info.get(1) + "<br/>" + "School: " + info.get(2) + "<br/>"
				+ "Technique: " + info.get(3) + "<br/>" + "Type: " + info.get(4) + "<br/>" + "Form: " + info.get(7)
				+ "<br/>" + "Location: " + info.get(0) + "<br/>" + "<html>");
		panel1.add(pic);
		panel1.add(label3);
		frame2.add(panel1);
